...
class TestUser(unittest.TestCase):
    ...
    def test_setting_attributeValues(self):
        ...
        self.a.first_name = "Abraham"
        self.a.last_name = "Fatoki"
        self.a.email = "fatokiabraham@test.com"
        self.a.password = "pass"
        self.assertTrue(self.a.first_name, "Abraham")
        self.assertTrue(self.a.last_name, "Fatoki")
        self.assertTrue(self.a.email, "fatokiabraham@test.com")
